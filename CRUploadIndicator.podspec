#
#  Be sure to run `pod spec lint CRUploadIndicator.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/CRUploadIndicator"
  ...
  s.source       = { :git => "http://EXAMPLE/CRUploadIndicator.git", :tag => "0.0.1" }
